          ...
          {items.map((exchange)=>(
            <section className={`flex flex-col `}>
              <div className={`flex flex-row gap-4`}>
                <li key={exchange.id} className={`list-none px-0 sm:px-12 py-4 bg-[#A66EFF] w-[200px] sm:w-[300px] mt-4 text-center text-[16px] text-white font-normal `}>{exchange.title}</li>
